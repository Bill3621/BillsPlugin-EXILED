...
## Overview
This Plugin is a powerful addition to [SCP: Secret Laboratory](https://scpslgame.com/) that integrates seamlessly with the [EXILED plugin framework version 8.12.2]([https://github.com/Exiled-Team/EXILED/releases/tag/8.9.11](https://github.com/ExMod-Team/EXILED/releases/tag/v8.12.2)). Designed to enhance gameplay, this plugin introduces a range of features and Quality of Life improvements, including:
