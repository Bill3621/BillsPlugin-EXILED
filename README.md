...
## Overview
This Plugin is a powerful addition to [SCP: Secret Laboratory](https://scpslgame.com/) that integrates seamlessly with the [EXILED plugin framework version 9.0.0-alpha.19](https://github.com/Exiled-Team/EXILED/releases/tag/9.0.0-alpha.19). Designed to enhance gameplay, this plugin introduces a range of features and Quality of Life improvements, including:
